...
import eeg.MAIN.SetPreference;
import eeg.math.Convolution;
...
public class FIRMain extends Activity {
	...
	public void drawChart() {
		...
		TimeSeries series = new TimeSeries("Origin EEG signal");
		for (int i = 0; i < 512; i++) {
			series.add(x[i], LoadData.sinal[i]);
			Log.e("Y", ""+y[i]);
		}
