...
import eeg.FIR.Filter.FilterTypes;
import eeg.signalwindows.*;
import eeg.signalwindows.WindowFactory.WINDOWS;
import eeg.utils.Arrays;
...
public class FIRFilter {
	 ...
	 */
	private void rateTest(double bandPassFreqFrom, double bandPassFreqTo,
			double samplingFrequency) throws IllegalArgumentException {
