 ...
 * Matlab pou?ívá implementaci podle: 
 ...
 *  oproti matlabu a? 10^-6. Pravdìpodobnì je to tím, ?e matlab stejnì jako
 *  java pou?ívá nativní funkci exp(), která se v obou implementacích li?í.
 *
...
public class GaussWindow implements Window {
	...
	public GaussWindow(){
		//mo?ná sem dodìlám defaultní alpha = 2.5 jako je v matlabu
		this.alpha = 2.5; 
	}
	...
	/**
	 * Vrátí hodnotu rozptylu pou?itou v 
	 * */
	...
	public double[] getWinSequence(int orderRate) {
		...
		//pøenásobení oknem, co? je jako zapsání okna
